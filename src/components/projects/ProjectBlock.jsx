    ...
    render() {
        return (
          <aside style={{width: "68rem"}} className="pt-80 text-white items-center sticky h-screen w-96 p-4 space-y-4 font-mono">
              <div style={{width: "58rem"}} className="border-4 place-content-center grid grid-cols-4 border-green-800 rounded-sm">
                  ...
                  <div className="flex p-10 text-m"><a className="text-red-500" href="https://github.com/mipamarmion/bozo-scanner-client">Github Repo.</a></div>
              </div>
              <div style={{width: "58rem"}} className="border-4 place-content-center grid grid-cols-4 border-green-800 rounded-sm">
